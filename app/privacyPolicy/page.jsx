  ...
  return (
    <div className="py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8 sm:p-10 text-center sm:text-left space-y-8">
        ...
        <p>
          Last updated: <span className="italic">May 26, 2025</span>
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Stork Linkers.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Stork Linkers, accessible from{" "}
              <a
        ...
        <ul>
          <li>By email: sharoon.202105203@gcuf.edu.pk</li>
        </ul>
      </div>
    </div>
  );
