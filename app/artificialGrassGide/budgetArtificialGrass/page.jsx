  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.storklinkers.com/artificialGrassGide/budgetArtificialGrass"
        />
      </Head>
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="mb-10">
              ...
              <a
                ...
                className="inline-block bg-green-700 mt-4 text-white px-4 py-2 rounded-lg shadow hover:bg-green-800 active:bg-green-900 transition"
                target="_blank"
          ...
          >
            ...
            <p className="text-gray-800 text-sm">
              With the right choice, your outdoor space can stay green,
              low-maintenance, and pet-friendly all year long without breaking
              the bank.
            </p>
          </div>
        </div>
...
export default BudgetArtificialGrass;
