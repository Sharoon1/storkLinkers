...
function TermsService() {
  return (
    <>
      <Head>
        <title>Terms of Service | Stork Linkers</title>
        <meta
          name="description"
      ...
      <div className="py-10 px-4">
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8 sm:p-10 text-center sm:text-left space-y-8">
          ...
          <p>
            This website is operated by <strong>Stork Linkers.</strong>{" "}
            Throughout the site, the terms “we”, “us” and “our” refer to Stork
            Linkers. Stork Linkers offers this website, including all
          ...
          <p>
            ...
            reference only. WeThis site may contain certain historical
          ...
          <p>
            ...
            make sure you understand them before connection with any third-party
          ...
          <p>
            ...
            see <a href="/privacyPolicy">Privacy Policy</a>
          </p>
          <h3 id="section11">
          ...
          <p>
            ...
            implied warranties or conditions of merchantability, merchantable
            quality, fitness for a particular purpose, durability, title, and
            non-infringement. In no case shall Stork Linkers, our directors,
            ...
            service, or for any other claim related in any Powered by Shopify
            www.shopify.com strict liability or otherwise, arising from your use
            of any of the service or any products procured using the service, or
          ...
          <p className="mb-6">
            You agree to indemnify, defend and hold harmless Stork Linkers and
          ...
          <p className="mb-1">Stork Linkers</p>
          <p className="mb-1"> sharoon.202105203@gcuf.edu.pk.</p>
          <p className="mb-1">
            64, Street No. 8, Farooqabad, Faisalabad 38000, Pakistan
          </p>
          <p className="mb-1">+92 306 6079142</p>
        </div>
      </div>
    </>
  );
