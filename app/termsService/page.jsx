  ...
  return (
    <div className="py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8 sm:p-10 text-center sm:text-left space-y-8">
        ...
        <p>
          This website is operated by <strong>Stork Linkers.</strong> Throughout
          the site, the terms “we”, “us” and “our” refer to Stork Linkers. Stork
          Linkers offers this website, including all information, tools and
        ...
        <p>
          ...
          understand them before connection with any third-party websites.
        ...
        <p>
          ...
          case shall Stork Linkers, our directors, officers, employees,
          ...
          related in any Powered by Shopify www.shopify.com strict liability or
          ...
          to your use of the service or any product, including, but not limited
          to, any errors or omissions in any content, or any loss or damage of
          any kind incurred as a result of the use of the service or any content
        ...
        <p className="mb-6">
          You agree to indemnify, defend and hold harmless Stork Linkers and our
